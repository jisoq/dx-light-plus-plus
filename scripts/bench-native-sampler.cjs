...
const options = {
  ...
  averageRadiusPx: Number(process.env.DX_LIGHT_NATIVE_AVERAGE_RADIUS_PX || 12),
  smoothingAlphaPercent: Number(process.env.DX_LIGHT_NATIVE_SMOOTHING_ALPHA_PERCENT || 35),
  deadband: Number(process.env.DX_LIGHT_NATIVE_DEADBAND || 10),
...
const args = [
  ...
  "--averageRadiusPx", String(options.averageRadiusPx),
  "--smoothingAlphaPercent", String(options.smoothingAlphaPercent),
  "--deadband", String(options.deadband),
